...
//del usuario, pone la longitud de la palabra, como la longitud del vector. Después ingresa 
//la palabra en el vector, letra por letra, quedando cada letra de la palabra en un índice del vector. 
//Y también, guarda la cantidad de jugadas máximas y el valor que ingresó el usuario.
//Método longitud(): muestra la longitud de la palabra que se debe encontrar. Nota: buscar como 
...
//y false si la letra no estaba, ya que, cada vez que se busque una letra que no esté, se le restará 
