...
//automática. Crear una clase CadenaServicio en el paquete servicios que implemente los siguientes métodos:
...
public class Ejercicio_1 {
    ...
    public static void main(String[] args) {
        ...
        CadenaServicio servicios = new CadenaServicio();

        CadenaEntidad oracion = servicios.crearFrase();
        
        servicios.mostrarMenu(oracion); 
    }
