...
//a las clases. Nosotros nos encargaremos de almacenar esta información en un arreglo e iterar 
//con un bucle, solicitando en cada repetición que se ingrese el nombre de cada alumno.
...
//la ganancia en una semana por curso. Para ello, se deben multiplicar la cantidad de horas por día, 
...
public class Ejercicio_6 {
    ...
    public static void main(String[] args) {
        ...
        servicio.crearCurso(c1);
        servicio.calcularGananciaSemanal(c1);
